...
linq_operator_tests.o: linq_operator_tests.cpp linq_operator_tests.h enumerable_test_util.h linq.h linq_detail.h exception.h
	$(CXX) -c -std=c++11 tests/coveo/linq/linq_operator_tests.cpp -Ilib -Itests
linq_chaining_tests.o: linq_chaining_tests.cpp linq_chaining_tests.h linq.h linq_detail.h exception.h
